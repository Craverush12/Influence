        ...
        <div className="glass-card p-6 md:p-10 fade-in">
                ...
                {socials.map((social) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className={`absolute inset-0 bg-gradient-to-br ${platform?.gradient || 'from-purple-500 to-pink-500'} opacity-0 group-hover:opacity-10 transition-opacity`}></div>
                      
                      <div className="relative z-10 flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${platform?.gradient || 'from-purple-500 to-pink-500'} flex items-center justify-center shadow-lg`}>
          ...
          {!adding ? (
            <button
              ...
              className="w-full py-4 px-6 rounded-xl border-2 border-dashed border-white/20 text-white/60 hover:border-purple-500/50 hover:text-white transition-all flex items-center justify-center gap-3 font-semibold group"
            >
